	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form"  method="post" action="{{route('registro.formAdmin')}}">
                    ...
                    <div class="wrap-input100 validate-input" >
						<input class="input100" type="text" name="password1"  placeholder="Contraseña">
					</div>

                    <div class="wrap-input100 validate-input" >
						<input class="input100" type="text" name="password2" placeholder="Confirmar contraseña">
					</div>
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="{{route('login.admin')}}">
							Inicia sesion
